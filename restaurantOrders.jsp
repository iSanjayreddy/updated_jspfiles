    ...
    <div class="orders-card p-4 mb-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h2 class="fw-bold mb-0" style="color: var(--primary-color);">
                    <i class="fas fa-receipt me-2"></i>📋 Orders Received
                </h2>
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="d-flex justify-content-between align-items-center mb-3">
                                    ...
                                    <span class="status-badge ${order.order_status == 'Delivered' ? 'status-delivered' : 
                            ...
                            <div class="col-md-4 text-end">
                                <a href="${pageContext.request.contextPath}/restaurant/updateOrderStatus?orderId=${order.orderId}" 
        ...
        <c:if test="${empty orders}">
            <div class="text-center py-5">
                ...
                <p class="text-muted">Your orders will appear here once customers place them</p>
            </div>
        </c:if>
    </div>
</div>
